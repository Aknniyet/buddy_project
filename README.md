...
- The project is web-only; there is no mobile application yet.
- Email sending requires external SMTP credentials.
- Gemini responses require `GEMINI_API_KEY`; otherwise the assistant uses fallback logic.
- University system integration is not implemented.
...
- More advanced recommendation and matching models
- Mobile application
- Deeper integration with university systems
- More detailed admin analytics
- Production-grade observability and audit logs
